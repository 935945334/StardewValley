...
function LV_1() {
	...
	HouseNumM[132].firstChild.style.zIndex = 50;
...
function LV_2() {
	...
	HouseNumM[330].firstChild.style.zIndex = 50;
	for (var i = 0 ; i < Is_map.length; i++) {
		for (var x = 0 ; x < Is_map[i].length; x++) {
			var e = (Is_map[i])[x];
			// HouseNumT[e].firstChild.src = "imges/no.png";
